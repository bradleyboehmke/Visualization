...
As in the last section we can use faceting (`facet_wrap` and `facet_grid`) to produce small multiples and also visualize factors with PCPs.  Mosaic plots provide an alternative approach for multivariate categorical data.  Mosaic plots...
