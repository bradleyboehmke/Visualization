...
```{r, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', fig.width=8}
...
```{r, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', fig.width=6}
...
```{r, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', fig.width=5, fig.height=5}
...
```{r, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', fig.width=10, fig.height=5}
...
```{r, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', fig.width=10, fig.height=5, eval=FALSE}
